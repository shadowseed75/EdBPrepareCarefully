...
namespace EdB.PrepareCarefully {
    ...
    public class PrepareCarefully {
        ...
        public void InitializePawns() {
            ...
            PawnPayload copyPayload = UtilityCopy.CopyExposable(payload, PopulateCrossReferencesForInitialPawnCopying());
            ...
            for (int i = 0; i < pawnCount; i++) {
                Pawn copiedPawn = copyPayload.pawns[i];
            ...
            foreach (var hiddenPawn in copyPayload.worldPawns) {
